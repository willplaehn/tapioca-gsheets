...
setup(
    name='tapioca-gsheets',
    version=get_version(package),
    description='gsheets API wrapper using tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://github.com/willplaehn/tapioca-gsheets',
    packages=[
        'tapioca_gsheets',
    ],
    package_dir={'tapioca_gsheets': 'tapioca_gsheets'},
